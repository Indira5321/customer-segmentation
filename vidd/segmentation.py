...
kmeans=joblib.load("C:/Users/vunna/OneDrive/Desktop/CUSTOMER SEGMENTATION PROJECT/vid/kmeans_model.pkl")

scaler=joblib.load("C:/Users/vunna/OneDrive/Desktop/CUSTOMER SEGMENTATION PROJECT/vid/scaler.pkl")
...
recency =st.number_input("Recey (das since last purchases)", min_value=0,max_value=365,value=30)
